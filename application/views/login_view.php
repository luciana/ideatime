<html>
<?php
  //require("idea/application/views/twitteroauth.php");  
?>
<head>
       ...
       <p class="tagline center no-loggedin uppercase">
        ...
        <p class="tagline center">
           <?php if(empty($_SESSION['username'])){  ?>
           				<?php //echo anchor('welcome/login', 'Sign in with your twitter account', 'class="uppercase"') ?>
           				<a href=<?php echo '"' . site_url('welcome/login') . '" class="uppercase">'?> Sign in with your twitter account</a>
